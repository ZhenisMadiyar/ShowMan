...
import com.example.madiyarzhenis.showman.artist.tab_all_zayavka.TabAllZayavka;
import com.example.madiyarzhenis.showman.artist.tab_my_profile.TabMyProfile;
import com.example.madiyarzhenis.showman.artist.tab_my_zayavka.TabMyZayavka;

import java.util.ArrayList;
import java.util.HashMap;

public class ArtistMainTabActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View tabView1 = getLayoutInflater().inflate(R.layout._artist_tab_item_all_zayavka, mTabHost, false);
        View tabView2 = getLayoutInflater().inflate(R.layout._artist_tab_item_my_zayavka, mTabHost, false);
        View tabView3 = getLayoutInflater().inflate(R.layout._artist_tab_item_profile, mTabHost, false);

        final HashMap<Integer, Class> hm = new HashMap<>();
        hm.put(0, TabAllZayavka.class);
        hm.put(1, TabMyZayavka.class);
        hm.put(2, TabMyProfile.class);
        ...
        hashMapView2.put(0, "AllZayavka");
        hashMapView2.put(1, "MyZayavka");
        hashMapView2.put(2, "Profile");
